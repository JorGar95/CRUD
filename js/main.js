...
function Leer() {
    ...
    DataForm["linea"] = document.getElementById("linea").value
    return DataForm
}
function InsertarDatos(data) {
    ...
    columna3 = Fila.insertCell(3).innerHTML = data.linea
